...
export function AppearanceForm() {
  ...
  function onSubmit(data: AppearanceFormValues) {
    ...
    showSubmittedData(data, 'Bạn đã cập nhật tùy chọn giao diện:')
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Chọn chủ đề cho hệ thống.</FormDescription>
              <FormMessage />
              <RadioGroup
              ...
              >
                ...
                <FormItem>
                  <FormLabel className="[&:has([data-state=checked])>div]:border-primary">
                    ...
                    <div className="items-center rounded-md border-2 border-muted p-1 hover:border-accent">
                      <div className="space-y-2 rounded-sm bg-gradient-to-r from-white to-slate-900 p-2">
                        <div className="space-y-2 rounded-md bg-white/90 p-2 shadow-xs">
                          <div className="h-2 w-[80px] rounded-lg bg-[#ecedef]" />
                          <div className="h-2 w-[100px] rounded-lg bg-[#ecedef]" />
                        </div>
                        <div className="flex items-center space-x-2 rounded-md bg-slate-900/90 p-2 shadow-xs">
                          <div className="h-4 w-4 rounded-full bg-slate-400" />
                          <div className="h-2 w-[100px] rounded-lg bg-slate-400" />
                        </div>
                      </div>
                    </div>
                    <span className="block w-full p-2 text-center font-normal">Hệ thống</span>
                  </FormLabel>
                </FormItem>
              </RadioGroup>
            </FormItem>
